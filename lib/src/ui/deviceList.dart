...
import 'package:trackerx1/src/ble/ble_logger.dart';
import 'package:trackerx1/src/ble/ble_scanner.dart';
...
class DeviceListScreen extends StatefulWidget {
  const DeviceListScreen({Key? key, required this.device}) : super(key: key);
...
class _DeviceListScreenState extends State<DeviceListScreen> {
  ...
  void initState() {
    ...
    location.changeSettings(
        interval: 140, accuracy: loc.LocationAccuracy.powerSave);
